    ...
    _In_ int nShowCmd)
{
    ...
    //초기화
    /*myDeck.push_back(solitaire::Card(solitaire::Card::Type::Bear, 0, 0));
    myDeck.push_back(solitaire::Card(solitaire::Card::Type::Wolf, 120, 0));
    myDeck.push_back(solitaire::Card(solitaire::Card::Type::Dragon, 240, 0));*/
    gGame.Init(hWnd);
